...
| show_move_button             | bool        | **Optional** | `false`  | Show move button to move an item to a later date.                                                                                                                                                                                    |
| move_chore_by_days           | number      | **Optional** | `1`      | The number of days to move a chore from today when clicking the move button.                                                                                                                                                                    |
| move_task_by_days            | number      | **Optional** | `1`      | The number of days to move a task from today when clicking the move button.                                                                                                                                                                     |
| move_icon                    | string      | **Optional** |          | Sets the icon used for the move button. Replaces the text. Set `use_icons` to true and don't use this parameter to use default icon.                                                                                                 |
| move_icon_size               | number      | **Optional** | `24`     | Sets the size of the icon for the move button.                                                                                                                                                                                       |
## Advanced options
